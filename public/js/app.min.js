...
!function(){"use strict";function t(t,e){t.state("app",{url:"/app","abstract":!0,templateUrl:"app/templates/base.html",controller:"BaseCtrl as Base"}).state("app.login",{url:"/login",templateUrl:"app/templates/login.html",controller:"LoginCtrl as Login"}),e.otherwise("/app/login")}angular.module("app.config",[]).config(t),t.$inject=["$stateProvider","$urlRouterProvider"]}();
!function(){"use strict";angular.module("app",["ui.router","app.run","app.config","app.controllers","app.factories","app.services"])}();
!function(){"use strict";function n(n){}angular.module("app.run",[]).run(n),n.$inject=["$rootScope"]}();