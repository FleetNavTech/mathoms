...
!function(){"use strict";function t(t,e){t.state("app",{url:"","abstract":!0,templateUrl:"app/templates/base.html",controller:"BaseCtrl as Base"}).state("app.login",{url:"/login",templateUrl:"app/templates/login.html",controller:"LoginCtrl as Login"}),e.otherwise("/login")}angular.module("app.config",[]).config(t),t.$inject=["$stateProvider","$urlRouterProvider"]}();
